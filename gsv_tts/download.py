...
def check_pretrained_models(models_dir):
    model_list = [
        os.path.join(models_dir,"chinese-hubert-base"),
        os.path.join(models_dir,"fast_langdetect"),
        os.path.join(models_dir,"text"),
        os.path.join(models_dir,"sv"),
    ]
    ...
    if is_download:
        ...
        download_model(
            ...
            zip_filename=os.path.join(models_dir,"pretrained_models.zip")
        )