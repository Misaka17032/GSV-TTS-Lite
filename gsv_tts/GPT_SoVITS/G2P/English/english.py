...
class EnglishG2P(G2p):
    def __init__(self, models_dir):
        ...
        self.CMU_DICT_PATH = os.path.join(models_dir,r"text\en\cmudict.rep")
        self.CMU_DICT_FAST_PATH = os.path.join(models_dir,r"text\en\cmudict-fast.rep")
        self.CMU_DICT_HOT_PATH = os.path.join(models_dir,r"text\en\engdict-hot.rep")
        self.CACHE_PATH = os.path.join(models_dir,r"text\en\engdict_cache.pickle")
        self.NAMECACHE_PATH = os.path.join(models_dir,r"text\en\namedict_cache.pickle")
