...
def get_base_url():
    ...
    if ms_ok and not hf_ok:
        logging.info("Selected ModelScope (Hugging Face is down).")
        return "https://modelscope.cn/models/chinokiki"
        
    if hf_ok and not ms_ok:
        logging.info("Selected Hugging Face (ModelScope is down).")
    ...
    if ms_latency < hf_latency:
        logging.info("Selected ModelScope (Lower latency).")
        return "https://modelscope.cn/models/chinokiki"
    else:
        logging.info("Selected Hugging Face (Lower latency or equal).")
        return "https://huggingface.co/cnmds"
