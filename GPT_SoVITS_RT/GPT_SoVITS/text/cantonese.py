...
import cn2an
import ToJyutping
from text.zh_normalization.char_convert import simplified_to_traditional
...
def jyuping_to_initials_finals_tones(text, jyuping_syllables):
    initials_finals = []
    tones = []
    word2ph = {"word":[], "ph":[]}
...
def g2p(text):
    ...
    phones, word2ph = jyuping_to_initials_finals_tones(simplified_to_traditional(text), jyuping)
    return phones, word2ph